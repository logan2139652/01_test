...
def generate_mininet_flow(flow_num):
    # src and dest
    flow_source = ["h1", "h2", "h3", "h4", "h5", "h6", "h7", "h8", "h9", "h10"]
    flow_destination = ["h1", "h2", "h3", "h4", "h5", "h6", "h7", "h8", "h9", "h10"]
    domain1 = flow_source
    domain2 = flow_destination
    # (period, deadline)集合
    period_deadline = np.array([(200, 800), (400, 1000), (800, 2000),
                                (400, 1000), (800, 2000)])
    # period_deadline = np.array([(200, 800), (400, 1000)])
    # period_deadline = np.array([(800, 2000), (400, 1000)])

    length = [1000, 100, 500, 1500]
    # length = [1000, 100, 500, 100, 100, 1500, 500, 1500]
