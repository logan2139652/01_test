...
@ author:hx
@ data:2023/05/09
A7C2数据处理 与 src.scheduling.data_processing.mininet_data.py和算法模块同用
...
import math
import numpy as np
from src.db.topology.A7C2topo import A7C2topo, topoRoute
...
if __name__ == '__main__':
    mininet = A7C2Net(excel_path=r'D:\Python\PyCharmWorkplace\01ArticleOneCode\src\db\dataset\A7C2_1000.xlsx',
