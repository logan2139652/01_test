...
# 均衡 791, 769, 772, 807, 929
# 大  875, 863, 850, 916, 999
# 小  597, 622, 666, 717, 801

# 数据
# greedy (833 not 673)
categories = ['greedy', 'tabu-search', 'q_learning', 'DQN', 'GQ_DQN']
values1 = [597, 622, 666, 717, 801]
values2 = [791, 769, 772, 807, 929]
values3 = [875, 863, 850, 916, 990]
...
plt.title("A7C2Net | DataSet1/2/3 | Periods=[20ms,40ms,80ms]", fontsize=14)
plt.ylim(0, 1000)
plt.grid(True, linestyle='--', linewidth=0.5, color='gray', zorder=0)
# 设置 x 轴刻度标签
